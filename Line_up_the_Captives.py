...
Beta Rabbits statisticians have asked you for some numerical analysis of how this
could be done so that they can explore the best options.
...
added to the facility roster, you can make the guards think there are
...
arrange n rabbits of unique heights along an east to west line, so that only
x are visible from the west, and only y are visible from the east. The return
...
Notes
==================
Mathematically I couldn't quite get to the answer, but a very helpful post by
the user Taylan on StackExchange pointed me in the correct direction:
